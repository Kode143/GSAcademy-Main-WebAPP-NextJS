...
export default function Header() {
    ...
    return (
        <header className="sticky top-0 bg-white shadow-md z-50 flex items-center justify-between px-4">
            ...
            <div className=" grid grid-rows-7 items-center w-full h-auto top-0 justify-end">
                <div className="row-span-2 flex items-center justify-around text-sm bg-black bg-opacity-5 shadow-md p-1">
