...
const FacilitiesCard = () => {
  return (
    ...
    <AnimatedBox>
      <div href="#" className="flex flex-col lg:flex-row items-center bg-white cursor-pointer border border-gray-200 rounded-lg shadow-md  hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 w-full h-full lg:h-64">
        ...
        <div className="object-cover w-full lg:w-1/2 h-full md:h-auto md:w-full md:rounded-t-lg md:rounded-s-lg relative">
          <Image height={50} width={300}
            src="/images/clab1.jpg" // Update the image source for the first card
      ...
      <div href="#" className="flex flex-col lg:flex-row items-center bg-white cursor-pointer border border-gray-200 rounded-lg shadow-md  hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 w-full h-full lg:h-64">
        ...
        <div className="flex flex-col justify-between p-4 ms-2 w-full lg:w-1/2 leading-normal">
          <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Transportation</h5>
